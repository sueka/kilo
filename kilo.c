...
void editorScroll() { // TODO: delete ifs
  E.rx = 0;
  if (E.cy < E.numrows) {
  ...
  switch (key) {
    ...
    case ARROW_RIGHT:
      if (row && E.cx < row->size) {
        E.cx++;
      } else if (E.cy < E.numrows) { // https://viewsourcecode.org/snaptoken/kilo/04.aTextViewer.html#moving-right-at-the-end-of-a-line
        E.cy++;
        E.cx = 0;
      }
      break;
...
void initEditor() {
  ...
  E.screenrows -= 2; // status bar lines
}
